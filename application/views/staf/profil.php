<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="text-center md:text-left text-white">
                    ...
                    <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                        <span class="inline-flex items-center px-3 py-1 bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 rounded-full text-sm font-medium">
                            <i class="fas fa-tools mr-2"></i> Staf IT Teknisi
                        </span>
                        <span class="inline-flex items-center px-3 py-1 bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 rounded-full text-sm font-medium">
                            <i class="fas fa-tag mr-2"></i> <?php echo $user->spesialisasi; ?>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="p-8">
            ...
            <?php echo form_open_multipart('staf/update_profil', ['class' => 'space-y-6']); ?>
