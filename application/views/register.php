...
<body class="bg-brand-base min-h-screen flex items-center justify-center p-4 md:p-6 lg:p-8 antialiased">
    ...
    <div
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-8 tracking-tight">Create your account</h2>

            <?php echo form_open_multipart('auth/register_action'); ?>
            <div class="space-y-5">

                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Full
                        Name</label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Daftar
                        Sebagai (Role)</label>
                    <select name="role_selector" id="role_selector" onchange="toggleSpesialisasi()"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-emerald/40 focus:border-brand-emerald transition-all">
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Foto
                        Profil (Opsional)</label>
                    <input type="file" name="foto" accept="image/png, image/jpeg, image/jpg"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-sm font-medium text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100 transition-all cursor-pointer">
                </div>

                <div id="spesialisasi_container" class="hidden">
                    <label
                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 ml-1">Spesialisasi
                        Staf IT</label>
                    <select name="spesialisasi_id" id="spesialisasi_id"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-emerald/40 focus:border-brand-emerald transition-all">
            ...
            <p class="text-center text-sm text-gray-500 mt-8">
                ...
                <a href="<?= base_url('auth') ?>"
                    class="text-brand-navy font-bold hover:text-brand-emerald transition-colors ml-1">Login
                    now</a>
            </p>
